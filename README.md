# OfflineMapExplorer
![](https://github.com/KanesRF/OfflineMapExplorer/blob/master/offlinemap.png)
...
![Структура проекта](/Components.png)
...
5.1  Получить объект TileRender.
5.2 Отрисовать клетку.
5.3. Вернуть объект TileRender.
